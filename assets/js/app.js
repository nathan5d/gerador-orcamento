...
discountInput.addEventListener('input', function () {
    ...
    // Chame a função updateTotal com o valor do desconto convertido em porcentagem
    updateTotal(parseFloat(discountValue.replace(',', '.')));
});
...
document.getElementById('export-button').addEventListener('click', function () {
    ...
    if (discountInput.value) {
        //console.log('Valor do campo de desconto:', discountInput.value);
        discountPercentage = parseFloat(discountInput.value.replace(',', '.')) || 0;// / 100;
        // console.log('Valor do desconto convertido:', discountPercentage);
    }

    budgetData.discount = discountPercentage;
    // console.log('Valor do desconto em budgetData:', budgetData.discount);
